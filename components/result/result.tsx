  ...
  return <main className="result-page">
    ...
    <div className="result-shell">
      ...
      <section className="summary-grid" aria-label="Résumé des réponses">
        ...
        <article className="summary-card"><h2>Trois qualités</h2><p className="summary-value">{a.qualities.join(" · ")}</p><p className="summary-comment">Tu es trop modeste, je suis sûr que tu en as plus.</p></article>
        <article className="summary-card"><h2>Trois petits défauts</h2><p className="summary-value">{a.defauts.join(" · ")}</p><p className="summary-comment">Dossier classé confidentiel… en théorie.</p></article>
